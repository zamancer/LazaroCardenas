...
describe("Artist model", () => {
  it("find should resolve", () =>
    Artist.find().then(res => expect(res).to.be.an("array")));
  ...
  it("should create an Artist", () => {
    ...
    return Artist.create(testArtist).then(res => {
  ...
  it("should retrieve an Artist by id", () =>
    Artist.findOne({
      where: {
        id: 1
      }
  ...
  it("should retrieve multiple detailsFor Artists", () => {
    ...
    return Promise.resolve()
      ...
      .then(art => {
        ...
        const assignedCredentials = Object.assign({}, credentials1, {
          ownerId: art.id
        });
      ...
      .then(art => {
        persistedArtistsIds.push(art.id);
        const assignedCredentials = Object.assign({}, credentials2, {
          ownerId: art.id
        });
        Credential.create(assignedCredentials);
      })
  ...
  it("should retrieve Artist detail", () => {
    ...
    return Promise.resolve()
      ...
      .then(art => {
        const assignedCredentials = Object.assign({}, credentials, {
          ownerId: art.id
        });
        Credential.create(assignedCredentials);
      })
